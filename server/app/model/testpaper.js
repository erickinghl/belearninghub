...
module.exports = app => {
    ...
    const Testpaper = app.model.define('testpaper', {
        ...
        question_count: { type: INTEGER, allowNull: false, defaultValue: 0, comment: '题目数' },
    ...
    Testpaper.associate = function () {
        Testpaper.hasMany(app.model.Question, { foreignKey: 'testpaper_id' });
    };
